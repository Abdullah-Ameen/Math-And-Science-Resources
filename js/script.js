document.addEventListener('DOMContentLoaded', function () {
    ...
    navbarCollapse.addEventListener('hidden.bs.collapse', function () {
        // When the navbar is fully hidden, change the icon back to the hamburger
        navbarToggler.innerHTML = '<span class="navbar-toggler-icon"></span>';
    });

    navbarCollapse.addEventListener('shown.bs.collapse', function () {
        // When the navbar is fully shown, change the icon to the close (X) button
        navbarToggler.innerHTML = '<span class="closingbutton">X</span>';
    });
});
